...
public class CommUtil {
	...
	// RETURN: xx
	// ACTIONS: xx
	public static JSONObject GetSpots(Context context, String userName, String searchMethod, String searchValue, String category, Integer limit, Integer radius, String query) {
